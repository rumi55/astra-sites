...
require ADI_DIR . '/importers/wxr-importer/class-parsers.php';
...
<?php
		...
		function author_select( $n, $author ) {
			...
			} else { _e( 'or assign posts to an existing user:', 'wordpress-importer' );
			}
		...
		function fetch_remote_file( $url, $post ) {
			...
			$headers = Astra_WXR_Importer::wp_get_http( $url, $upload['file'] );
